import{j as t}from"./client-UYj9Bh4x.js";const l=`<svg viewBox="0 0 28 28" aria-hidden="true" width="100%" height="100%" style="display:block">
...
</svg>`;function n({size:e=28,className:i=""}){return t.jsx("span",{className:i,style:{display:"inline-block",width:e,height:e,lineHeight:0,flexShrink:0},"aria-hidden":!0,dangerouslySetInnerHTML:{__html:l}})}export{n as S};
